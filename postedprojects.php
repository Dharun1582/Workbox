...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $sql="SELECT Budget FROM postedprojects WHERE UserName='".$username."'";
            $res=mysqli_query($conn,$sql);
        ...
        <?php
            for($i=0;$i<$length;$i++){
                ...
                echo "&nbsp;";
                echo "<form action='Bidders.php' method='POST' style='width:fit-content;display:inline-block'>";
                echo "<div class='card'>";
                echo "<img src='1.jpg'  style='width:100%;height:180px'>";
                ...
                echo "<input type='submit' name='VIEW' value='VIEW BIDDERS' class='btnvw'>";
                echo "<input type='submit' name='SUBMIT' value='DELETE PROJECT' class='btn'>";
                echo "</div>";
                echo "</form>";
                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
